...
class Docinfo4 extends StatelessWidget {
  @override
            ...
            children: <Widget>[
              Container(
                ...
                child: Container(
                  ...
                  child: Image.asset('images/doctorimage/doc5.jpg'),
                ),
              ),
              Container(
                        ...
                        Row(
                          children: <Widget>[
                            Container(
                              height: 100,
                              width: 100,
                              child: Image.asset('images/docaniket.jpg'),
                            ),
                            SizedBox(
                              width: 20,
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Text("      Dr. Aniket Singh", style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w400,
                                ),),
                                Text("neurologist- A.K Hospital", style: TextStyle(
                                  fontSize: 17,
                                  fontWeight: FontWeight.w400,
                                ),)
                              ],
