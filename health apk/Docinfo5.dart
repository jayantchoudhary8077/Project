...
class Docinfo5 extends StatelessWidget {
  @override
            ...
            children: <Widget>[
              Container(
                ...
                child: Container(
                  ...
                  child: Image.asset('images/vikas.jpeg'),
                ),
              ),
              Container(
                        ...
                        Row(
                          children: <Widget>[
                            Container(
                              height: 100,
                              width: 100,
                              child: Image.asset('images/doctorimage/doc6.png'),
                            ),
                            SizedBox(
                              width: 20,
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Text("      Dr. Vikas Gupta", style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w400,
                                ),),
                                Text("Dermatologist- A.K Hospital", style: TextStyle(
                                  fontSize: 17,
                                  fontWeight: FontWeight.w400,
                                ),)
                              ],
