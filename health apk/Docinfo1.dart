...
class Docinfo1 extends StatelessWidget {
  @override
            ...
            children: <Widget>[
              Container(
                ...
                child: Container(
                  ...
                  child: Image.asset('images/docshweta1.jpg'),
                ),
              ),
              Container(
                        ...
                        Row(
                          children: <Widget>[
                            Container(
                              height: 100,
                              width: 100,
                              child: Image.asset('images/docshweta.jpg'),
                            ),
                            SizedBox(
                              width: 20,
                            ),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: <Widget>[
                                Text("      Dr. Shweta Singh", style: TextStyle(
                                  fontSize: 20,
                                  fontWeight: FontWeight.w400,
                                ),),
                                Text("Gynaelogist- A.K Hospital", style: TextStyle(
                                  fontSize: 17,
                                  fontWeight: FontWeight.w400,
                                ),)
                              ],
